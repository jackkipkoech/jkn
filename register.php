    ...
    <div class="navbar navbar-default yamm" role="navigation" id="navbar">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="jack.html" data-animate-hover="bounce">
            ...
            <div class="container">
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <p>Registration with us opens a new world of user support, fantastic discounts and much more to you! The whole process will not take you more than a minute!</p>
                        <p class="text-muted">If you have any questions, please feel free to <a href="contacts.php">contact us</a>, our customer service center is working for you 24/7.</p>
                        ...
                        include ('config.php');
                            ...
                            <p>The Name field is required.</p></div>';
                            }elseif(isset($_POST['o_names']) && $_POST['o_names']==""){
                            echo '<div class="alert-danger">
                            <p>The Other Name field is required.</p></div>';
                            }elseif(isset($_POST['reg_email']) && $_POST['reg_email']==""){
                            echo '<div class="alert-danger">
                            <p>The Email field is required.</p></div>';
                            }elseif(isset($_POST['passwordA']) && $_POST['passwordA']==""){
                            echo '<div class="alert-danger">
                            <p>The Password field is required.</p></div>';
                            }elseif($_POST['passwordA'] != $_POST['passwordB']){
                            echo '<div class="alert-danger">
                            <p>The Password do not match.</p></div>';
                            }else{
                            $sql =" INSERT INTO user (fname, othername, email, password,passwordb) VALUES('".$_POST['f_name']."','".$_POST['o_names']."','".$_POST['reg_email']."','".md5($_POST['passwordA'])."','".md5($_POST['passwordB'])."')";
                            mysqli_query($con, $sql) or die(mysqli_error($con));
                            echo '<div class="alert-success">
                            <p>You are added Successfully.</p></div>';
                        ...
                        <form action="" method="post" accept-charset="utf-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="o_names" class="form-control" id="name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="passwordA" class="form-control" id="password">
                            </div>
                            <div class="form-group">
                                <label for="passwordB">Repeat Password</label>
                                <input type="password" name="passwordB" class="form-control" id="passwordB">
                            </div>
                            <div class="text-center">
                                <button type="submit" name="SubmitReg" value="submit"  class="btn btn-primary"><i class="fa fa-user-md"></i> Register</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <p class="text-muted">Log in using your registered email and password if you are already a registered customer.</p>
                        ...
                        <form action="login.php" method="post" accept-charset="utf-8">
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="text" name="login_email" required="required" class="form-control" id="email">
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" name="login_pass" required="required" class="form-control" id="password">
                            </div>
                            <div class="text-center">
                                <button type="submit" name="SubmitLogin" class="btn btn-primary"><i class="fa fa-sign-in"></i> Log in</button>
                            </div>
                        </form>
                    </div>
                </div>
