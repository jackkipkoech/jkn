        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img src="images/slider1.png" alt="" class="img-responsive">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="images/slider2.png" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="images/slider3.png" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="images/slider5.png" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
                    ...
                    <div class="same-height-row">
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <p>You get the most affordable unlimited Internet rates  at Wiltel Internet.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <p>To provide affordable internet, information technology and telecommunication services.</p>
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
                ...
                <div class="col-md-12">
                    <div class="box slideshow">
                        ...
                        <div id="get-inspired" class="owl-carousel owl-theme">
                            <div class="item">
                                <a href="#">
                                    <img src="images/lan.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="images/network.png" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="images/responce.png" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
