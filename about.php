        ...
        <div class="container">
            ...
            <div class="col-md-6" data-animate="fadeInDown">
                <ul class="menu">
                    ...
                    <li><a href="register.phpphp">Register</a>
                    </li>
              
                    <li><a href="contacts.phpphp">Contact</a>
                    </li>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="wiltel.co.ke.php" data-animate-hover="bounce">
                    ...
                    <img src="images/favicon.png" alt="witel logo" class="visible-xs"><span class="sr-only">Obaju - go to homepage</span>
                </a>
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    ...
                    <div class="box" id="text-page">
                        <h1>About Wiltel Company</h1>

                        <p class="lead">We are a Kenyan based company operating in several counties. 
                        We engage our customers with a focus on listening to and supporting their needs.</p>
    
                
                        <div class="row">
                            <div class="col-lg-5 col-md-6 col-sm-5 scrollpoint sp-effect1">
                                <div class="media media-left feature">
                                    <blockquote>
                                        <h3 class="media-heading">Mision</h3>
                                        
                       To become a leader in providing reliable and high quality information technologies, internet and telecommunication services in an award winning and customer friendly environment, while maintaining high industry standards.
                                    </blockquote>
                                </div>
                                <div class="media media-left feature">
                                    <blockquote>
                                        <h3 class="media-heading">Distinction</h3>
                                        Here at Wiltel Company, we pursue <strong>quality and excellence </strong>in every assignment we execute.
                                    </blockquote>
                                </div>
                                <div class="media media-left feature">
                                    <blockquote>
                                        <h3 class="media-heading">Delight</h3>
                                        Guided by our customer needs, we endeavor to <strong>surpass expectations </strong>and remain relevant in the industry.
                                    </blockquote>
                                </div>
                            </div>
                            <div class="col-lg-2 hidden-md hidden-sm hidden-xs" >
                                <img src="http://www.skylinknetworks.co.ke/assets_w/img/bk-freeze.jpg" class="img-responsive img-thumbnail " alt="">
                            </div>
                            <div class="col-lg-5 col-md-6 col-sm-6 scrollpoint sp-effect2">
                                <div class="media feature">
                                    <blockquote>
                                        <h3 class="media-heading">Dependability</h3>
                                        Our word is our bond; <strong>Our promise is our commitment</strong>.
                                    </blockquote>
                                </div>
                                <div class="media feature">
                                    <blockquote>
                                        <h3 class="media-heading">Delight</h3>
                                        Guided by our customer needs, we endeavor to surpass our customers expectations, create a positive emotional reaction and remain relevant in the industry.
                                    </blockquote>
                                </div>
                                <div class="media feature">
                                    <blockquote>
                                        <h3 class="media-heading">Passion</h3>
                                        We posses an intense emotion, compelling<strong> enthusiasm and desire </strong> for all that we do.
                                    </blockquote>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <p class="text-center">
                                    <img src="http://www.skylinknetworks.co.ke/assets_w/img/team.jpg" class="img-thumbnail img-responsive" alt="">
                                </p>
                                <p class="text-center">Wilord Metet</p>
                            </div>
                            <div class="col-md-4">
                                <p class="text-center">
                                    <img src="http://www.skylinknetworks.co.ke/assets_w/img/team.jpg" class="img-thumbnail  img-responsive" alt="">
                                </p>
                                <p class="text-center">Betty Bii</p>
                            </div>
                            <div class="col-md-4"> 
                                <p class="text-center">
                                    <img src="http://www.skylinknetworks.co.ke/assets_w/img/team.jpg" class="img-thumbnail img-responsive" alt="">
                                </p>
                                <p class="text-center">Erick Bore</p>
                            </div>
                        </div>
